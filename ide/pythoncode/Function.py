...
class Function:
    ...
    def startCondition(tocondition, window:Text):
        ...
        while Function.isCondition(condition):
            ...
            Function.interpret(toInterpret, window)
    ...
    def interpret(tointerpret:list, window:Text):
        for line in tointerpret:
            ...
            elif line.startswith("?"):   Function.output = "\nERROR: Condition in conditions in not allowed.\n"
